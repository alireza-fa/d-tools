...
class TestClient(SimpleTestCase):
    ...
    def test_device_name(self):
        ...
        client_info = client.get_client_info(request=request)
        self.assertEqual(client_info[client.DEVICE_INFO], "test-device")

    def test_device_name_empty(self):
        request = RequestFactory().get(path="/")
        client_info = client.get_client_info(request=request)
        print(client_info[client.DEVICE_INFO])
        self.assertEqual(client_info[client.DEVICE_INFO], "")
